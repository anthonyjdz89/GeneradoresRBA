...
class _EditarClienteWidgetState extends State<EditarClienteWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'editar-cliente'});
    _model.clienteIDTextController ??=
        TextEditingController(text: widget!.cliente?.clienteId);
    ...
    _model.documentoTextController ??=
        TextEditingController(text: widget!.cliente?.documentID);
    _model.documentoFocusNode ??= FocusNode();

    _model.emailTextController ??=
        TextEditingController(text: widget!.cliente?.correoElectronico);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('EDITAR_CLIENTE_arrow_back_rounded_ICN_ON');
              context.pop();
            },
          ),
          title: Text(
          ...
          actions: [
            Align(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('EDITAR_CLIENTE_home_rounded_ICN_ON_TAP');
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'ClienteID',
                      hintText: 'Ingresa el Id personalizado',
                      hintStyle:
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDITAR_CLIENTE_EDITAR_CLIENTE_BTN_ON_TAP');
                        ...
                        await widget!.cliente!.reference
                          ...
                          correoElectronico: _model.emailTextController.text,
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'la información del cliente se ha actualizado!'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
